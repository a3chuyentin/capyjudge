...
SITE_NAME = "CapyJudge"
SITE_LONG_NAME = "CapyJudge"
SITE_ADMIN_EMAIL = "capyjudge@gmail.com"
...
# EVENT_DAEMON_KEY = 'capyjudge'  # Must match backend_auth_token in websocket/config.js
